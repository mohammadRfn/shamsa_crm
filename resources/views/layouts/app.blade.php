...
<body class="bg-dark-900 text-cream-100 font-sans antialiased">
    ...
    <div class="relative min-h-screen flex flex-col">
        ...
        @isset($header)
        <header class="header-luxury sticky top-16 z-30">
        ...
        <main class="flex-1">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                <div class="bg-green-500/15 border-2 border-green-500/40 text-green-300 px-6 py-4 rounded-xl flex items-center gap-3 animate-shimmer shadow-lg">
            ...
            @if(session('error'))
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
                <div class="bg-red-500/15 border-2 border-red-500/40 text-red-300 px-6 py-4 rounded-xl flex items-center gap-3 shadow-lg">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <footer class="footer-luxury mt-12">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
