                ...
                <div class="card-luxury p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('reports.create') }}"
                            class="flex items-center gap-3 p-4 bg-cream-100 hover:bg-cream-200 rounded-xl transition-all group border-2 border-cream-300 hover:border-primary-400">
