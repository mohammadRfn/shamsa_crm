        ...
        <div class="max-w-7xl mx-auto space-y-8">
            ...
            <div class="card-luxury p-6">
                <form method="GET" action="{{ route('workrequests.index') }}" class="flex flex-col lg:flex-row gap-4">
                    ...
                    <a href="{{ route('workrequests.index', ['view' => $viewMode]) }}" class="btn-secondary lg:w-auto">حذف فیلتر</a>
                    @endif
                </form>
            </div>
            ...
            @if($viewMode === 'grid')
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 view-grid-mode">
                @foreach($workRequests as $request)
                <div class="card-luxury p-6 hover:shadow-2xl hover:shadow-primary-900/20 hover:scale-[1.02] transition-all duration-300 group {{ $request->isUnreadBy() ? 'card-unread' : '' }}"
                    ...
                    <div class="flex items-start justify-between mb-4 pb-4 border-b-2 divider">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                <span class="text-sm text-dark-400">درخواست: {{ $request->request_number }}</span>
                    ...
                    <div class="flex gap-2 pt-4 border-t-2 divider">
                        <a href="{{ route('workrequests.show', $request) }}" class="flex-1 btn-secondary text-center py-2">
                        ...
                        <a href="{{ route('workrequests.edit', $request) }}" class="px-4 py-2 bg-yellow-500/20 text-yellow-400 rounded-lg hover:bg-yellow-500/30 transition-all border-2 border-yellow-500/30">
